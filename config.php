<?php
	...
	**/
	if(!ini_get('date.timezone') ){date_default_timezone_set("Africa/Cairo");} # list of timezones here http://php.net/manual/en/timezones.php Europe/Paris Europe/Madrid Europe/London etc.
	$default_language='en';
	$debug_mode=false;
	...
	#############################################################
	$default_path='images/'; 												# upload folder
